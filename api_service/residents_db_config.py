...
LOCAL_CONNECTION_STRING = f"mssql+pyodbc://{USER_NAME}:{USER_PASSWORD}@{LOCAL_SERVER}/{DATABASE_NAME}?driver=ODBC+Driver+17+for+SQL+Server&TrustServerCertificate=yes"
...
AZURE_CONNECTION_STRING = f"mssql+pyodbc://{USER_NAME}:{USER_PASSWORD}@{AZURE_SERVER}/{DATABASE_NAME}?driver=ODBC+Driver+17+for+SQL+Server&TrustServerCertificate=yes"
