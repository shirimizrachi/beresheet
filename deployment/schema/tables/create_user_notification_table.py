...
Usage: python create_user_notification_table.py <schema_name>
"""

import sys
from sqlalchemy import create_engine, text

def create_user_notification_table(schema_name: str):
    """
    Create the user_notification table in the specified schema
...
def main():
    ...
    if len(sys.argv) != 2:
        print("Usage: python create_user_notification_table.py <schema_name>")
        print("Example: python create_user_notification_table.py beresheet")
        sys.exit(1)
    ...
    success = create_user_notification_table(schema_name)
    if not success:
        sys.exit(1)
