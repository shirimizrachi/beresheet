# Build Flutter Web Applications for Production
# This PowerShell script builds both web-tenant and web-admin applications

Write-Host "[INFO] Building Flutter web applications for production..." -ForegroundColor Green
...
flutter build web --target lib/main_web.dart --dart-define=ENVIRONMENT=production --output api_service/web-tenant
...
flutter build web --target lib/main_admin.dart --dart-define=ENVIRONMENT=production --output api_service/web-admin
...
Write-Host "[INFO] All Flutter web applications built successfully!" -ForegroundColor Green
